...
import type { CommandDocs } from '../../utils/types.js'

const choices = ['dev', 'info', 'fun', 'music', 'mod']
	...
	public async commands(
		...
		try {
			...
			if (!group) {
				...
				groupCommands = allCommands.filter(
					(cmd) => cmd.category === group
				)
